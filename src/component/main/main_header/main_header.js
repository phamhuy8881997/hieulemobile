        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <a
                type="button"
                className="btn btn-lg btn-primary ml-3 btn__exitModal"
                href="/cartshop"
              >
                Thanh Toán Mua Hàng
              </a>
              <button
                type="button"
                className="btn btn-lg btn-secondary ml-3 btn__exitModal"
                data-dismiss="modal"
              >
                Thoát
              </button>
    ...
    resule = items.map((item, i) => {
      return (
        <li key={`ssxx${i}`}>
          ...
          <Link to={`tat-ca-san-pham/${item}`} className="text__menu">
            {item}
          </Link>
        </li>
      );
