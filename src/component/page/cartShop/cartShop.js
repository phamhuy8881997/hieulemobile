...
function CartShop(props) {
  ...
  const formSuccesKey = (value) => {
    let isKeyOption = JSON.parse(localStorage.getItem("keyCartShop"));
    setMaXacNhan(isKeyOption.buyCart);
    //console.log("-------", isKeyOption.buyCart);
    setFormload(value);
  };
  //==================xác nhận mua hàng ===============================
  //==================copy ma don hang ================================
  ...
  return (
    <Fragment>
      ...
      {/*--------------------- formload ===4 --------------------*/}
      {formload === "4" && (
        <div className="formload4 text-center">
          <CodePhone />
          <div>
            <button
              type="button"
      ...
      {formload === "5" && (
        <div className="formload4 text-center">
          {maXacNhan ? (
            <div className="formload5">
              <p>mã OTP hợp lệ có thể thanh toán mua hàng</p>
              <button
                type="button"
                className="btn btn-lg btn-primary my-4 mx-4"
                onClick={() => formloadPrevNext("4")}
            ...
            <div className="formload5">
              <p>chưa lấy mã OPT xác nhận lòng kiểm tra lại</p>
              <button
                type="button"
                className="btn btn-lg btn-primary my-4 mx-4"
                onClick={() => formloadPrevNext("4")}
